...
"" {{{1
" Метод получает или устанавливает опцию буферу.
...
"" {{{1
" Метод устанавливает содержимое буфера. Возможно только если буфер активен.
...
"" {{{1
" Метод выполняет заданную последовательность для буфера. Возможно только если буфер активен.
